...
{
    public class Building_StuffedPowerPlantSolarMini : Building_PowerPlant
    {
        private float FullSunPower;
        private const float NightPower = 0f;
        private static readonly Vector2 BarSize = new Vector2(1.15f, 0.14f);
        ...
        public override void Draw()
        {
            ...
            r.size = Building_StuffedPowerPlantSolarMini.BarSize;
            r.fillPercent = this.powerComp.PowerOutput / FullSunPower;
            r.filledMat = Building_StuffedPowerPlantSolarMini.BarFilledMat;
            r.unfilledMat = Building_StuffedPowerPlantSolarMini.BarUnfilledMat;
            r.margin = 0.15f;
